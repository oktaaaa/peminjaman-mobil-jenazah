            ...
            <div class="card">
                <div class="card-header d-flex justify-content-between">
                    <div class="header-title">
                        <h4 class="card-title">Data Mobil Jenazah</h4>
                    </div>
                </div>
                <div class="card-body">
                    <a href="{{ route('mobil.create')}}" type="button" class="btn btn-primary rounded-pill ">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <form action="{{route('mobil.destroy', $item->id)}}" method="post">
                                            ...
                                            @csrf
                                            @method('DELETE')
                                            <button type="submit" class="btn btn-sm btn-icon text-danger show_confirm" data-bs-toggle="tooltip" data-bs-original-title="Hapus">
                                                <span class="btn-inner">
                                            ...
                                            <a class="btn btn-sm btn-icon text-primary flex-end" data-bs-toggle="tooltip" title="" href="{{route('mobil.edit', $item->id)}}" data-bs-original-title="Edit">
                                                <span class="btn-inner">
