            ...
            <div class="card">
                <div class="card-header d-flex justify-content-between">
                    <div class="header-title">
                        <h4 class="card-title">Selamat Datang di SIMOZA</h4>
                        <h5>Klik di sini untuk buat permohonan untuk peminjaman mobil jenazah</h5>
                    </div>
                </div>
                <div class="card-body">
                    <a a href="{{ route('permohonan.create')}}" type="button" class="btn btn-primary rounded-pill ">
