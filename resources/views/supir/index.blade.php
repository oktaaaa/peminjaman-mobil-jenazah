            ...
            <div class="card">
                <div class="card-header d-flex justify-content-between">
                    <div class="header-title">
                        <h4 class="card-title">Data Supir Test</h4>
                    </div>
                </div>
                <div class="card-body">
                        ...
                        <table id="datatable" class="table table-striped" data-toggle="data-table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <form action="{{route('supir.destroy', $item->id)}}" method="post">
                                            {{-- @csrf
                                            @method('DELETE')
                                            ...
                                            <a class="btn btn-sm btn-icon text-primary flex-end" data-bs-toggle="tooltip" title="" href="{{route('supir.edit', $item->id)}}" data-bs-original-title="Edit">
                                                <span class="btn-inner">
