                        ...
                        <table id="datatable" class="table table-striped" data-toggle="data-table">
                            ...
                            <tbody>
                                ...
                                <tr data-id="{{ $item->id }}">
                                    ...
                                    <td class="mobil-cell">
                                        <span class="mobil-text">{{ $item->mobil ? $item->mobil->plat . ' - ' .
                                            $item->mobil->brand : 'N/A' }}</span>
                                        <select name="mobil_id" class="mobil-dropdown form-select d-none">
                                            <option value="">Pilih Mobil</option>
                                            @foreach ($mobils as $mobil)
                                            <option value="{{ $mobil->id }}" {{ $item->mobil_id == $mobil->id ?
                                                'selected' : '' }}>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            $('.ok-button').on('click', function () {
                ...
                // If status is 'selesai', remove the row and send to another page
                if (status === 'selesai') {
                    ...
                    $.ajax({
                        ...
                        success: function (response) {
                            if (response.success) {
                                ...
                                window.location.href = "statuspermohonan/okur";
                            } else {
