<ul class="navbar-nav iq-main-menu" id="sidebar">
    ...
    <li class="nav-item">
        <a class="nav-link {{activeRoute(route('mobil.index'))}}" aria-current="page" href="{{route('mobil.index')}}">
            <i class="icon">
                <svg width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path fill-rule="evenodd" clip-rule="evenodd"
            ...
            <span class="item-name">Mobil</span>
        </a>
    </li>

    <li class="nav-item">
        <a class="nav-link {{activeRoute(route('supir.index'))}}" aria-current="page" href="{{route('supir.index')}}">
            <i class="icon">
                <svg width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path
            ...
            <span class="item-name">Supir</span>
        </a>
    </li>

    <li class="nav-item">
        <a class="nav-link {{activeRoute(route('orangwafat.index'))}}" aria-current="page"
            href="{{route('orangwafat.index')}}">
            <i class="icon">
                <svg width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path
    ...
    <li class="nav-item">
        <a class="nav-link {{activeRoute(route('permohonan.index'))}}" aria-current="page"
    ...
    <li class="nav-item">
        <a class="nav-link {{activeRoute(route('statuspermohonan.index'))}}" aria-current="page"
            href="{{route('statuspermohonan.index')}}">
            <i class="icon">
    ...
    <li class="nav-item mb-5">
        ...
        <ul class="sub-nav collapse" id="sidebar-icons" data-bs-parent="#sidebar">
            <li class="nav-item">
                <a class="nav-link {{activeRoute(route('permohonan.report'))}}" href="{{route('permohonan.report')}}">
                    <i class="icon">
